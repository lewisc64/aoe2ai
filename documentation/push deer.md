...
=>
    ...
    (up-get-point position-self 42)
    (up-set-target-point 42)
...
=>
    ...
    (up-get-object-data 38 44)
    (up-get-object-data 39 45)
    (up-lerp-tiles 44 42 c: -170)
    (up-reset-filters)
    ...
    (up-target-point 44 action-default -1 -1)
...
=>
    ...
    (up-get-point position-object 42)
